...
#define COCOAPODS_VERSION_MINOR_FDTake 1
#define COCOAPODS_VERSION_PATCH_FDTake 0
...
#define COCOAPODS_VERSION_PATCH_MWPhotoBrowser 4

// MWPhotoBrowser/ARC
#define COCOAPODS_POD_AVAILABLE_MWPhotoBrowser_ARC
#define COCOAPODS_VERSION_MAJOR_MWPhotoBrowser_ARC 1
#define COCOAPODS_VERSION_MINOR_MWPhotoBrowser_ARC 1
#define COCOAPODS_VERSION_PATCH_MWPhotoBrowser_ARC 4
